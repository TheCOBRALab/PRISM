/*
  ...
  gengetopt --input=prism.ggo --c-extension=cc --header-extension=hh --arg-struct-name=args_info --unamed-opts=input
...
const char *args_info_usage = "Usage: PRISM [options] [sequence]";
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVr:i:o:n:pkd:P:s:Og:S:f:L", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'L':	/* Change the RNA shape to level 6 (Default is 5).  */
          ...
          if (update_arg((void *)&(args_info->level_flag), 0, &(args_info->level_given),
              &(local_args_info.level_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "level", 'L',
              additional_error))
            goto failure;
